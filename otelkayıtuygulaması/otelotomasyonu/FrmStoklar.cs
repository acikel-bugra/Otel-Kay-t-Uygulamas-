    ...
    public partial class FrmStoklar : Form
    {
        ...
        private void veriler()
        {
            ...
            while(oku.Read())
            {
                ...
                ekle.SubItems.Add(oku["Oyuncak"].ToString());
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Stoklar(Gıda,İcecek,Oyuncak)values('" + TxtGıda.Text + "','" + Txtİcecek.Text + "','" + TxtOyuncak.Text + "')",baglanti);
